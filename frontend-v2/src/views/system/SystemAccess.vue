...
.ds-card{border:1px solid #e4ebf5;border-radius:16px;background:rgba(255,255,255,.98);box-shadow:0 10px 30px rgba(42,83,163,.04);overflow:hidden}
.user-table-card{overflow:visible}.ds-table th{height:44px;background:#fbfcfe;color:#78889f;font-size:11px;font-weight:650;border-bottom:1px solid #edf2f7}.ds-table td{height:52px;border-bottom:1px solid #f0f3f7;color:#465a73}.ds-table tbody tr:hover td{background:#f7faff}.ds-resource{color:#17304f;font-weight:650}.user-inline-action{border-radius:7px!important;color:#53677f!important}.user-inline-action:hover{background:#edf4ff!important;color:#2468d8!important}
:global(.user-action-popper.el-popper){border:1px solid #e6edf6!important;border-radius:12px!important;box-shadow:0 14px 34px rgba(30,60,110,.14)!important}:global(.user-action-popper .el-dropdown-menu){border-radius:12px!important}:global(.user-action-popper .el-dropdown-menu__item){border-radius:7px;color:#42566f}:global(.user-action-popper .el-dropdown-menu__item:not(.is-disabled):hover){background:#eef5ff;color:#2468d8}
.permission-note{border-color:#dfe8f3;border-radius:10px;background:#f6f9fd;color:#60728a}.permission-table{border:1px solid #e5ecf5;border-radius:10px;overflow:hidden}.permission-table th{height:40px;background:#fbfcfe;color:#78889f}.permission-table td{border-bottom-color:#eef2f7;color:#42566f}.permission-table tbody tr:hover td{background:#f7faff}
:deep(.el-dialog){border-radius:16px;overflow:hidden;box-shadow:0 24px 64px rgba(30,60,110,.16)}:deep(.el-dialog__header){margin:0;padding:18px 22px 14px;border-bottom:1px solid #edf1f6;background:#fff}:deep(.el-dialog__body){background:#fbfdff;padding:20px 22px}:deep(.el-dialog__footer){padding:12px 20px 16px;background:#fff;border-top:1px solid #edf1f6}
:deep(.el-drawer){background:#fbfdff}:deep(.el-drawer__header){margin:0;padding:18px 22px;border-bottom:1px solid #edf1f6;background:#fff}:deep(.el-drawer__body){padding:18px 20px}:deep(.el-descriptions__table){border-radius:10px;overflow:hidden}:deep(.el-descriptions__label){background:#f7faff!important;color:#78889f!important}
:deep(.el-input__wrapper),:deep(.el-select__wrapper),:deep(.el-textarea__inner){border-radius:9px;box-shadow:0 0 0 1px #dfe8f3 inset}:deep(.el-button){border-radius:8px}
