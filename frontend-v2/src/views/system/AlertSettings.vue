...
async function test(row:AlertSetting){if(!row.enabled)return ElMessage.warning('告警配置已关闭，请先启用');testingId.value=row.id;try{await accessApi.testAlertSetting(row.id);ElMessage.success('钉钉测试消息已发送')}catch(e){ElMessage.error(msg(e))}finally{testingId.value=null}}
...
.alert-settings-page{padding-top:28px;padding-bottom:36px;background:linear-gradient(180deg,#fbfdff 0%,#f8fbff 100%)}
.alert-summary{gap:12px;margin-bottom:16px;border:0;background:transparent}.alert-summary>div{min-height:96px;padding:17px 18px;border:1px solid #e4ebf5;border-radius:14px;background:#fff;box-shadow:0 8px 24px rgba(42,83,163,.035)}.alert-summary>div:last-child{border-right:1px solid #e4ebf5}.alert-summary span{color:#8291a5;font-size:11px}.alert-summary strong{margin-top:10px;color:#17304f;font-size:22px;line-height:1.2}.alert-summary>div:nth-child(2){background:linear-gradient(180deg,#fff,#f6fbf8)}
.alert-card{border:1px solid #e4ebf5;border-radius:16px;background:#fff;box-shadow:0 10px 30px rgba(42,83,163,.04)}.alert-toolbar{padding:16px 18px;border-bottom-color:#edf2f7;background:#fbfdff}.alert-toolbar strong{color:#17304f}.alert-toolbar p{color:#8796aa}.name-cell strong{color:#17304f}.ding-icon{width:30px;height:30px;border-radius:9px;background:#eaf3ff;color:#2468d8}.trigger-chip{border:1px solid #dfe8f3;border-radius:999px;background:#f6f9fd;color:#52677f}.secret-tip{color:#8796aa}.actions :deep(.el-button){border-radius:7px}
.alert-card :deep(.el-table){--el-table-header-bg-color:#fbfcfe;--el-table-row-hover-bg-color:#f7faff;--el-table-border-color:#eef2f7}.alert-card :deep(.el-table th.el-table__cell){height:44px;background:#fbfcfe;color:#78889f;font-size:11px;font-weight:650}.alert-card :deep(.el-table td.el-table__cell){border-bottom-color:#f0f3f7}
.empty-alert{padding:64px 20px;color:#8796aa}.empty-alert>.el-icon{color:#9db5d4}.empty-alert strong{color:#17304f}
.drawer-head h3{color:#17304f}.drawer-head p{color:#8796aa}:deep(.alert-drawer){background:#fbfdff}:deep(.alert-drawer .el-drawer__header){margin:0;padding:18px 22px;border-bottom:1px solid #edf1f6;background:#fff}:deep(.alert-drawer .el-drawer__body){padding:18px 22px;background:#fbfdff}:deep(.alert-drawer .el-drawer__footer){padding:12px 20px 16px;border-top:1px solid #edf1f6;background:#fff}.alert-form :deep(.el-input__wrapper),.alert-form :deep(.el-select__wrapper),.alert-form :deep(.el-textarea__inner){border-radius:9px;box-shadow:0 0 0 1px #dfe8f3 inset}.template-help{color:#8796aa}.template-help code{display:inline-block;margin:2px 5px 2px 0;padding:2px 5px;border-radius:5px;background:#edf4ff;color:#346fca}:deep(.el-button){border-radius:8px}
@media(max-width:1100px){.alert-summary{grid-template-columns:repeat(2,1fr)}.alert-summary>div:nth-child(2){border-right:1px solid #e4ebf5}}
