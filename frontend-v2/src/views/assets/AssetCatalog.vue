...
.asset-summary{background:#fff;border:1px solid var(--line);border-radius:10px;margin-bottom:14px;padding:0 18px;height:52px;display:flex;align-items:center}.summary-item{position:relative;display:flex;align-items:center;gap:7px;padding:0 26px;min-width:150px;height:52px;border:0;background:transparent;cursor:pointer}.summary-item:first-child{padding-left:0}.summary-item:not(:last-of-type):after{content:"";position:absolute;right:0;top:50%;transform:translateY(-50%);width:1px;height:24px;background:#edf0f4}.summary-item b{font-size:22px;line-height:1;font-weight:700;color:#25324b;font-variant-numeric:tabular-nums}.summary-item span{font-size:12px;line-height:1;color:#667085}.summary-item:hover b,.summary-item.active b{color:var(--blue)}.summary-item:hover span,.summary-item.active span{color:#344054}.summary-note{margin-left:auto;height:52px;display:flex;align-items:center;color:#98a2b3;font-size:12px;line-height:1}
...
/* AssetTable is an inner component: deep selectors are required for the reference table styles to reach its DOM. */
:deep(.asset-table-wrap){overflow:auto;padding:0 16px 16px}
:deep(.asset-table){width:100%;border-collapse:collapse;table-layout:fixed}
:deep(.asset-table th){height:42px;background:#fafbfc;color:#667085;font-size:12px;font-weight:600;text-align:left;padding:0 12px;border-bottom:1px solid var(--line)}
:deep(.asset-table td){height:62px;padding:10px 12px;border-bottom:1px solid #eef1f5;color:#344054;font-size:12px;vertical-align:middle}
:deep(.asset-table tbody tr:hover td){background:#fcfdff}
:deep(.asset-name){border:0;background:transparent;padding:0;color:#245fd8;font:inherit;font-weight:600;cursor:pointer;text-align:left;appearance:none}
:deep(.asset-desc){margin-top:4px;color:#98a2b3;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
:deep(.type-badge){height:23px;padding:0 8px;border-radius:999px;background:#eef4ff;color:#275fc2;font-size:11px;display:inline-flex;align-items:center;border:0}
:deep(.type-badge.table){background:#eefaf6;color:#16825f}
:deep(.type-badge.dataset){background:#f4f1ff;color:#6c55bd}
:deep(.owner){display:flex;align-items:center;gap:7px}
:deep(.owner-avatar){width:25px;height:25px;border-radius:50%;background:#eef2f7;display:grid;place-items:center;color:#667085;font-size:11px;font-weight:600;flex:none}
:deep(.row-actions){display:flex;align-items:center;gap:4px;white-space:nowrap}
:deep(.star){border:0;background:transparent;color:#98a2b3;font-size:18px;line-height:1;cursor:pointer;padding:4px;appearance:none}
:deep(.star.on){color:#2f6bff}
:deep(.text-action){border:0;background:transparent;color:#245fd8;font:inherit;font-size:12px;cursor:pointer;padding:4px;appearance:none}
:deep(.muted-cell){color:#98a2b3!important}
:deep(.asset-empty){height:180px;display:grid;place-items:center;color:#98a2b3;font-size:12px}
.directory-right :deep(.asset-table-wrap){flex:1;padding:0 18px 18px}
