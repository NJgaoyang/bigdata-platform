...
@media(max-width:1600px){.login-main{padding-left:5vw;padding-right:5vw;gap:36px}.hero-panel h1{font-size:clamp(40px,3.7vw,58px)}.data-scene{height:350px}.login-card{max-width:440px;min-height:540px;padding:42px 38px 34px}}
@media(max-width:1320px){.login-header{padding:0 34px}.login-main{grid-template-columns:minmax(0,1.16fr) minmax(410px,.84fr);padding:22px 3.5vw 66px;gap:28px}.hero-panel h1{font-size:clamp(36px,3.8vw,50px)}.hero-subtitle{font-size:17px}.feature-row{margin-top:38px}.feature-item{padding-left:14px;padding-right:14px}.feature-icon{width:36px;height:36px}.data-scene{height:300px;margin-top:22px}.scene-card{transform:scale(.9);transform-origin:center}.scene-source{left:2%;top:150px}.scene-dev{left:28%;top:76px}.scene-warehouse{right:8%;top:66px}.scene-governance{right:-2%;top:176px}.login-card{max-width:420px;min-height:520px;padding:38px 34px 30px}.card-head{margin-bottom:24px}.login-field{height:54px}.login-button{height:56px}.trust-line{margin:23px 0 16px}}
