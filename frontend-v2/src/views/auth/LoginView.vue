    ...
    <main class="login-main">
      ...
      <section class="login-side">
        <div class="login-card">
          ...
          <template v-else>
            <div class="card-head">
              <div><h2>账号登录</h2><p>使用企业内部账号登录 DataSphere</p></div>
              <div class="internal-badge">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 3 5 6v5c0 4.7 2.8 8 7 10 4.2-2 7-5.3 7-10V6l-7-3Z"/><path d="m9 12 2 2 4-4"/></svg>
                <span>企业内部系统</span>
              </div>
            </div>
            ...
            <div class="security-tip">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="12" cy="12" r="9"/><path d="M12 10v6M12 7h.01"/></svg>
              <div><b>访问提示</b><p>本系统仅限企业内部授权人员使用。账号权限由平台管理员统一维护，所有关键操作均保留审计记录。</p></div>
            </div>
...
.trust-line{display:flex;align-items:center;gap:12px;margin:28px 0 19px;color:#91a4c0;font-size:12px}.trust-line span{height:1px;flex:1;background:#d4deec}.trust-line em{font-style:normal;white-space:nowrap}.security-tip{display:flex;gap:10px;padding:11px 13px;border:1px solid #d9e7ff;border-radius:10px;color:#627899;background:#eaf2ff}.security-tip svg{width:18px;height:18px;flex:none;margin-top:1px;color:#4476c5}.security-tip b{display:block;color:#34537d;font-size:12px}.security-tip p{margin:3px 0 0;font-size:11px;line-height:1.6}.card-foot{margin-top:19px;color:#9aabc4;font-size:11px;text-align:center}.slogan{position:absolute;left:5.4vw;bottom:28px;z-index:3;color:#62bfff;font-size:13px;letter-spacing:5px}.slogan strong,.slogan span,.slogan small{display:block}.slogan strong{margin-bottom:4px;color:#8ed4ff;font-size:15px;letter-spacing:8px}.slogan small{margin-top:9px;color:#527cab;font-size:9px;letter-spacing:2.2px}.login-page footer{position:absolute;left:0;right:0;bottom:15px;z-index:4;color:#5f789e;font-size:10px;letter-spacing:.3px;text-align:center}
@media(max-width:1320px){.login-main{grid-template-columns:minmax(0,1.28fr) minmax(430px,.72fr);padding-left:4vw;padding-right:4vw}.feature-row{margin-top:30px}.data-scene{height:340px}.scene-source{top:170px}.scene-governance{top:210px}}
@media(max-width:1120px){.login-main{grid-template-columns:1fr;padding-top:34px}.data-scene{display:none}.feature-row{margin-bottom:30px}.login-side{justify-content:flex-start}.login-card{width:100%;max-width:560px}.slogan,.login-page footer{display:none}}
</style>
