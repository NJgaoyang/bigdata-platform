...
@media(min-width:1051px){.login-card{transform:translate(-58px,-45px)}}
@media(max-width:1500px){.top-brand{left:54px}.intro-pane{padding-left:11vw;padding-right:5vw}.login-pane{padding-right:4.5vw}.login-card{width:min(480px,100%);padding:40px 36px 44px}.hero-copy h1{font-size:clamp(54px,4.7vw,72px)}.hero-copy h2{font-size:clamp(29px,2.35vw,38px)}}
@media(max-height:820px) and (min-width:1051px){.top-brand{top:16px}.intro-pane{padding-top:92px;padding-bottom:92px}.hero-copy{transform:translateY(-20px)}.hero-copy h1{margin-bottom:18px;font-size:clamp(48px,4.3vw,66px)}.hero-copy h2{margin-bottom:18px;font-size:clamp(27px,2.2vw,35px)}.tagline{font-size:clamp(20px,1.55vw,25px)}.short-rule{margin:22px 0 18px}.subline{font-size:clamp(16px,1.12vw,20px)}.login-pane{padding-top:78px;padding-bottom:78px}.login-card{padding:36px 36px 40px;transform:translate(-42px,-24px)}.card-title h2{font-size:33px}.card-title p{margin-bottom:26px;font-size:17px}.field{margin-bottom:18px}.input-wrap input{height:50px;font-size:16px}.form-meta{margin-bottom:22px}.login-button{height:54px}.modern-login-page footer{bottom:18px;font-size:12px}}
