...
@media(max-height:820px) and (min-width:1121px){.login-main{padding-top:14px;padding-bottom:40px}.hero-panel h1{font-size:clamp(34px,3.5vw,52px)}.hero-subtitle{margin-top:12px;font-size:16px}.feature-row{margin-top:22px}.data-scene{height:270px;margin-top:8px}.scene-source{top:132px}.scene-dev{top:62px}.scene-warehouse{top:54px}.scene-governance{top:158px}.login-card{min-height:0;padding-top:28px;padding-bottom:24px}.card-head{margin-bottom:22px}.login-field{height:50px;margin-bottom:14px}.form-options{margin-bottom:18px}.login-button{height:52px}.trust-line{margin:20px 0 14px}.card-foot{margin-top:14px}.slogan{display:none}}
@media(max-height:700px) and (min-width:1121px){.feature-row{display:none}.data-scene{height:220px}.scene-card{transform:scale(.8)}.scene-source{top:100px}.scene-dev{top:40px}.scene-warehouse{top:34px}.scene-governance{top:120px}.login-main{padding-top:18px;padding-bottom:30px}.login-card{padding:24px 30px 20px}.trust-line{margin:16px 0 12px}.login-page footer{display:none}}
