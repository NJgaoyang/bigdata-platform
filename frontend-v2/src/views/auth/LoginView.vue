      ...
      <section class="hero-panel">
        ...
        <div class="feature-row">
          ...
          <article class="feature-item">
            ...
            <div><h3>智能调度运维</h3><p>统一任务调度、运行监控、告警与生产问题定位。</p></div>
          </article>
          <article class="feature-item">
            <div class="feature-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M5 4h14v5H5zM5 15h14v5H5z"/><path d="M8 9v6M16 9v6"/></svg>
            </div>
            <div><h3>全链路数据治理</h3><p>元数据、数据血缘、版本审计与数据资产能力统一沉淀。</p></div>
          </article>
        </div>
        ...
        <div class="data-scene" aria-hidden="true">
          ...
          <div class="scene-card scene-source">
            <b>数据汇聚</b>
            <div class="scene-chart"><svg viewBox="0 0 180 50" preserveAspectRatio="none"><polyline fill="none" stroke="#3fb7ff" stroke-width="2" points="0,40 22,33 42,35 65,20 85,25 105,13 130,18 155,10 180,14"/></svg></div>
            <small>MySQL · SeaTunnel · Flink CDC</small>
          </div>
          <div class="scene-card scene-dev">
            <b>数据开发</b><small>SQL Development</small><small>版本管理 · 调度配置</small><small>上线 · 发布</small>
          </div>
          <div class="scene-card scene-warehouse">
            <b>任务调度</b>
            <div class="scene-flow"><i></i><b></b><i></i><b></b><i></i></div>
            <div class="scene-flow"><span></span><i></i><b></b><i></i><span></span></div>
            <small>依赖编排 · 周期调度 · 运行实例</small>
          </div>
          <div class="scene-card scene-governance">
            <b>数据治理</b><small>元数据　● 正常</small><small>数据血缘　● 完整</small><small>版本审计　● 已启用</small>
          </div>
        </div>
      </section>
...
.trust-line{display:flex;align-items:center;gap:12px;margin:28px 0 19px;color:#91a4c0;font-size:12px}.trust-line span{height:1px;flex:1;background:#d4deec}.trust-line em{font-style:normal;white-space:nowrap}.card-foot{margin-top:19px;color:#9aabc4;font-size:11px;text-align:center}.slogan{position:absolute;left:5.4vw;bottom:44px;z-index:3;color:#62bfff;font-size:16px;letter-spacing:6px}.slogan strong,.slogan span,.slogan small{display:block}.slogan strong{margin-bottom:5px;color:#8ed4ff;font-size:19px;letter-spacing:8px}.slogan span{color:#72c9ff;font-size:16px;letter-spacing:6px}.slogan small{margin-top:12px;color:#527cab;font-size:10px;letter-spacing:2.8px}.login-page footer{position:absolute;left:0;right:0;bottom:15px;z-index:4;color:#5f789e;font-size:10px;letter-spacing:.3px;text-align:center}
@media(max-width:1600px){.login-main{padding-left:5vw;padding-right:5vw;gap:36px}.hero-panel h1{font-size:clamp(40px,3.7vw,58px)}.data-scene{height:350px}.login-card{max-width:440px;min-height:500px;padding:40px 38px 26px}}
@media(max-width:1320px){.login-header{padding:0 34px}.login-main{grid-template-columns:minmax(0,1.16fr) minmax(410px,.84fr);padding:22px 3.5vw 66px;gap:28px}.hero-panel h1{font-size:clamp(36px,3.8vw,50px)}.hero-subtitle{font-size:17px}.feature-row{margin-top:38px}.feature-item{padding-left:14px;padding-right:14px}.feature-icon{width:36px;height:36px}.data-scene{height:300px;margin-top:22px}.scene-card{transform:scale(.9);transform-origin:center}.scene-source{left:2%;top:150px}.scene-dev{left:28%;top:76px}.scene-warehouse{right:8%;top:66px}.scene-governance{right:-2%;top:176px}.login-card{max-width:420px;min-height:480px;padding:36px 34px 24px}.card-head{margin-bottom:24px}.login-field{height:54px}.login-button{height:56px}.trust-line{margin:23px 0 16px}}
...
@media(max-width:760px){.login-header{height:60px;padding:0 20px}.brand{gap:9px}.brand-logo{width:30px;height:30px}.brand strong{font-size:19px}.brand span{display:none}.login-main{min-height:calc(100dvh - 60px);padding:28px 20px 40px}.eyebrow{font-size:10px;letter-spacing:1.7px}.hero-panel h1{font-size:clamp(30px,9vw,42px);line-height:1.12}.hero-panel h1 span{display:block;margin-top:4px}.hero-subtitle{margin-top:12px;font-size:14px;letter-spacing:.8px}.feature-row{grid-template-columns:1fr;gap:12px;margin:22px 0 24px}.feature-item{padding:0 0 12px;border-right:0;border-bottom:1px solid rgba(128,172,235,.18)}.feature-item:last-child{padding-bottom:0;border-bottom:0}.feature-item p{font-size:11px}.login-card{width:100%;padding:28px 24px 24px;border-radius:14px}.card-head h2{font-size:25px}.card-head p{font-size:13px}.login-field{height:52px;margin-bottom:14px}.form-options{margin-bottom:20px}.login-button{height:54px;font-size:16px}.trust-line{margin:22px 0 16px}}
@media(max-width:480px){.login-main{padding:22px 14px 28px}.hero-panel h1{font-size:30px}.hero-subtitle{font-size:13px}.feature-row{display:none}.login-card{padding:24px 18px 20px}.card-head{margin-bottom:22px}.card-head h2{font-size:23px}.login-field{height:50px}.login-field input{padding-left:42px;font-size:14px}.field-icon{left:14px;width:18px;height:18px}.password-toggle{right:11px}.form-options{font-size:13px}.login-button{height:52px}.card-foot{margin-top:15px}}
@media(max-height:820px) and (min-width:1121px){.login-main{padding-top:14px;padding-bottom:40px}.hero-panel h1{font-size:clamp(34px,3.5vw,52px)}.hero-subtitle{margin-top:12px;font-size:16px}.feature-row{margin-top:30px}.data-scene{height:270px;margin-top:16px}.scene-source{top:132px}.scene-dev{top:62px}.scene-warehouse{top:54px}.scene-governance{top:158px}.login-card{min-height:470px;padding-top:32px;padding-bottom:22px}.card-head{margin-bottom:22px}.login-field{height:50px;margin-bottom:14px}.form-options{margin-bottom:18px}.login-button{height:52px}.trust-line{margin:20px 0 14px}.card-foot{margin-top:14px}.slogan{left:3.5vw;bottom:38px;font-size:13px;letter-spacing:4px}.slogan strong{font-size:15px;letter-spacing:6px}.slogan span{font-size:13px;letter-spacing:4px}.slogan small{margin-top:7px;font-size:9px;letter-spacing:2px}.login-page footer{bottom:11px;font-size:9px}}
@media(max-height:700px) and (min-width:1121px){.feature-row{margin-top:18px}.feature-item p{display:none}.feature-icon{width:32px;height:32px}.data-scene{height:205px;margin-top:8px}.scene-card{transform:scale(.8)}.scene-source{top:100px}.scene-dev{top:40px}.scene-warehouse{top:34px}.scene-governance{top:120px}.login-main{padding-top:18px;padding-bottom:30px}.login-card{min-height:430px;padding:26px 30px 20px}.trust-line{margin:16px 0 12px}.slogan{bottom:28px}.login-page footer{display:none}}
@media(orientation:landscape) and (max-width:960px) and (max-height:620px){.login-header{height:54px}.login-main{min-height:calc(100dvh - 54px);grid-template-columns:minmax(0,.9fr) minmax(360px,1.1fr);align-items:center;padding:18px 24px 24px;gap:24px}.hero-panel .feature-row,.data-scene{display:none}.hero-panel h1{font-size:32px}.hero-subtitle{font-size:13px}.login-card{padding:22px 24px 18px}.card-head{margin-bottom:18px}.login-field{height:46px;margin-bottom:12px}.login-button{height:48px}.trust-line{display:none}.slogan,.login-page footer{display:none}}
