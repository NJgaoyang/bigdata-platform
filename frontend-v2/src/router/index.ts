...
{path:'assets/overview',component:()=>import('../views/assets/AssetHome.vue'),meta:{module:'assets'}},
...
{path:'assets/detail',component:()=>import('../views/assets/AssetDetail.vue'),meta:{module:'assets'}},
{path:'assets/map',component:()=>import('../views/assets/AssetMap.vue'),meta:{module:'assets'}},
{path:'assets/governance',component:()=>import('../views/assets/AssetGovernance.vue'),meta:{module:'assets'}},
