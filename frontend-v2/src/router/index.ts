...
{path:'metrics/domains',component:()=>import('../views/metrics/MetricsCenter.vue'),meta:{module:'metrics'}},
{path:'metrics/themes',component:()=>import('../views/metrics/MetricsCenter.vue'),meta:{module:'metrics'}},
{path:'metrics/dimensions',redirect:'/metrics/manage'},
{path:'metrics/lineage',redirect:'/metrics/manage'},
