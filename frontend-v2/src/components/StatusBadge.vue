...
const tone = computed(() => {
  ...
  if (value.includes('SUCCESS') || value.includes('FINISHED') || value.includes('COMPLETED') || value === 'ACTIVE' || value === 'RUNNING' || value === 'HEALTHY' || value === 'UP' || value === 'NORMAL' || value === 'OK') return 'success'
