...
public class FlinkRestClient {
    ...
    public JsonNode get(String base,String path){return send(base,path,"GET");}
    public JsonNode patch(String base,String path){return send(base,path,"PATCH");}
    private JsonNode send(String base,String path,String method){
        ...
        try{
            ...
            HttpRequest req="PATCH".equals(method)?b.method("PATCH",HttpRequest.BodyPublishers.noBody()).build():b.GET().build();
