...
public class QueryController {
    ...
    @GetMapping("/history") public Result<java.util.List<QueryHistoryView>> history() { return Result.ok(service.history()); }
    ...
    public Result<Void> cancel(@PathVariable String executionId, HttpServletRequest servletRequest) {
        ...
        audit.record("QUERY_CANCEL", "QUERY", null, "executionId=" + executionId, operator(servletRequest));
