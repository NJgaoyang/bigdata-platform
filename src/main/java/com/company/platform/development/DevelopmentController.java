...
public class DevelopmentController {
    ...
    @GetMapping("/projects")
    public Result<List<DevProjectView>> projects(@RequestParam(defaultValue = "mine") String scope, HttpServletRequest servletRequest) { return Result.ok(service.projects(operator(servletRequest), "all".equalsIgnoreCase(scope))); }
    ...
    public Result<DevProjectView> updateProject(@PathVariable long id, @Valid @RequestBody DevelopmentRequests.ProjectRequest request, HttpServletRequest servletRequest) { return Result.ok(service.updateProject(id, request, operator(servletRequest))); }
    ...
    public Result<DevFolderView> updateFolder(@PathVariable long id, @Valid @RequestBody DevelopmentRequests.FolderUpdateRequest request, HttpServletRequest servletRequest) { return Result.ok(service.updateFolder(id, request, operator(servletRequest))); }
    @GetMapping("/files")
